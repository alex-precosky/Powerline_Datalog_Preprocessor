...
class TestDataProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        DataProcessor.DataProcessor.__abstractmethods__ = set()
    ...
    def test_write_callback_called(self):
        ...
        processor = DataProcessor.DataProcessor(self.one_line_read_callback, write_callback)
    ...
    def test_process_called(self):
        ...
        processor = DataProcessor.DataProcessor(self.one_line_read_callback, self.null_write_callback)
